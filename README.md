...
![FlexiCity dashboard showing before/after load curves, comparison and price graphs, and peak/cost/CO₂ stats](Screenshot.png)
...
- Prices are a one-day Nord Pool snapshot recorded from the Helen website, not a live feed.
...
- Hourly Nordic electricity exchange (Nord Pool) prices, recorded from the Helen website (Helen is an electricity distribution company in Helsinki)
